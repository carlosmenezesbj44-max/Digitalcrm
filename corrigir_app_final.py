...
def listar_clientes(request: Request):
    try:
        ...
        return templates.TemplateResponse("clientes.html", {"request": request, "clientes": [], "error": str(e)})
...
print("   - Removido get_db nao utilizado da rota /clientes")
print("   - Adicionado try/except para melhor tratamento de erro")
