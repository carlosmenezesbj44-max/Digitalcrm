                    ...
                    <tbody id="corpoTabela">
                        {% if clientes %}
                            ...
                            <tr class="linha-cliente">
                                ...
                                <td>{{ cliente.data_cadastro.strftime("%d/%m/%Y") if cliente.data_cadastro else "N/A" }}</td>
                                <td>
...
print("clientes.html corrigido novamente!")
print("   - Adicionado verificacao se clientes existe")
print("   - Adicionado fallback para data")
