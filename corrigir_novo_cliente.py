...
print("novo_cliente.html corrigido!")
print("   - Removido script de geocoding que tentava chamar /clientes/geocode")
print("   - Mantido apenas o formulario basico de cadastro")
